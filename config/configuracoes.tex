...
\usepackage[none]{hyphenat}             % Usado para remover a quebra de linha em todo o texto, mas principalmente nos recuos das folhas de rosto e de eprovação
...
\setlength\epigraphwidth{.55\textwidth} % define um tamanho inicial do recuo
...
\makeindex[columns=3] % Configura quantidade de colunas do índice
